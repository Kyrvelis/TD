...
export const ENEMIES: Record<EnemyKind, EnemyDef> = {
  ...
  miniboss: { kind: "miniboss", name: "Mini-Boss", baseHp: 1200, speed: 38, reward: 150, damage: 40, radius: 22, color: "#ef4444", outline: "#1a0000", shape: "skull", description: "Devastating heavy unit. Costs ~40+ lives if it leaks." },
  boss:     { kind: "boss", name: "Boss", baseHp: 4800, speed: 30, reward: 540, damage: 60, radius: 30, color: "#ff2020", outline: "#1a0000",
              summon: { kind: "armored", interval: 6.0, perSpawn: 1 }, shape: "skull", description: "End-of-act warlord. Costs ~60+ lives if it leaks." },
  bossbrute:   { kind: "bossbrute", name: "Brute", baseHp: 1500, speed: 40, reward: 175, damage: 40, radius: 22, color: "#ef4444", outline: "#1a0000", shape: "skull",
                 description: "Devastating mini-boss. Costs 40+ lives if it leaks." },
  bossemp:     { kind: "bossemp", name: "EMP Walker", baseHp: 5400, speed: 26, reward: 650, damage: 60, radius: 30, color: "#fff37a", outline: "#332200", shape: "octagon",
                 empAttack: { range: 250, interval: 7.0, duration: 4.0, targets: 3 }, summon: { kind: "empdrone", interval: 8.0, perSpawn: 1 },
                 description: "Periodically stuns 3 nearby towers. Costs 60+ lives if it leaks." },
  bossaegis:   { kind: "bossaegis", name: "Aegis Titan", baseHp: 5800, speed: 28, reward: 650, damage: 60, radius: 32, color: "#9adfff", outline: "#0a1820", shape: "hex",
                 aegisAura: { range: 130, resist: 0.5 }, armored: true, resistances: { physical: 0.25, energy: 0.35 },
                 description: "Halves damage of nearby enemies. Costs 60+ lives if it leaks." },
  bossnecro:   { kind: "bossnecro", name: "Necromancer", baseHp: 5200, speed: 30, reward: 650, damage: 60, radius: 30, color: "#aa44ff", outline: "#220033", shape: "skull",
                 summon: { kind: "swarm", interval: 2.5, perSpawn: 3 }, necroOnDeath: { kind: "grunt", count: 4 },
                 description: "Constantly raises swarms. Costs 60+ lives if it leaks." },
  bosscloaker: { kind: "bosscloaker", name: "Wraith King", baseHp: 5600, speed: 34, reward: 650, damage: 60, radius: 30, color: "#222", outline: "#dc2626", shape: "skull",
                 hidden: true, cloakAura: { range: 160 }, summon: { kind: "stealth", interval: 5.0, perSpawn: 2 },
                 description: "Hidden. Cloaks allies. Costs 60+ lives if it leaks." },
  bossfinal:   { kind: "bossfinal", name: "Overlord", baseHp: 13000, speed: 28, reward: 1600, damage: 90, radius: 36, color: "#ff2020", outline: "#1a0000", shape: "skull",
                 ...
                 description: "Final boss. Costs 90+ lives if it leaks. Game over for most." },
};
