  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-br from-background via-[hsl(217_40%_12%)] to-background relative overflow-hidden">
      ...
      <div className="relative text-center px-8">
        ...
        <h1 className="text-6xl md:text-7xl font-black tracking-tight mb-3 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">TDX</h1>
